"""
Bluesky plans for the BDP M?? demo, 2024-07-09.
"""
...
DM_EXPERIMENT_NAME = "hedm-20240709"  # for testing & development
DM_WORKFLOW_NAME = "midas-ff"

ANALYSIS_SUBDIR = "analysis/hedm/ff_rec"
ANALYSIS_WORKSTATIONS = """caexperlifone polaris""".split()
...
PARAMETER_FILE_LOCAL = HOME_PATH / iconfig.get("ANALYSIS", {}).get("parameter_file", "ps_shade_au.txt")
EXAMPLE_DATA_FILE_LOCAL = HOME_PATH / iconfig["EXPERIMENT"].get("SAVE_DIRECTORY", "mpe") / "shade_Au_ff_000294.h5"
...
def mpe_bdp_demo_plan(
    ...
    num_images: int = 100,
    darkFileName: str = "dark_before_000112.edf.ge5",  # name of the dark file for MIDAS
    # This file will need to be copied into the experiment directory.
...
def mpe_setup_user(
    ...
    yield from bps.mv(det_name, detector_name)
